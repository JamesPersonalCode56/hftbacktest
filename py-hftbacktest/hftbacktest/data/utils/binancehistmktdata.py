...
def convert_snapshot(
    ...
    with open(snapshot_filename, 'r', newline='') as f:
        ...
        for row in reader:
            ...
            exch_ts = int(row[timestamp_col]) * 1_000_000
...
def convert(
    ...
    with open(depth_filename, 'r', newline='') as f:
        ...
        for row in reader:
            ...
            # Insert DEPTH_EVENT
            tmp[row_num] = (
                DEPTH_EVENT | (BUY_EVENT if row[side_col] == 'b' else SELL_EVENT) | EXCH_EVENT | LOCAL_EVENT,
                exch_ts,
                local_ts,
                px,
                qty,
    ...
    with open(trades_filename, 'r', newline='') as f:
        ...
        for row in reader:
            ...
            # Insert TRADE_EVENT
            tmp[row_num] = (
                TRADE_EVENT | (SELL_EVENT if row[side_col] else BUY_EVENT) | EXCH_EVENT | LOCAL_EVENT,  # trade initiator's side
                exch_ts,
                local_ts,
                px,
                qty,
